...
local function handle_fullscreen_of_app(c)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s", function() awful.spawn("screenshotterer.sh area") end,
        { description = "start screenshotting tool", group = "launcher" }),
    awful.key({ modkey, "Control" }, "r", awesome.restart,
        { description = "reload awesome", group = "awesome" }),
    awful.key({ modkey, "Shift" }, "q", awesome.quit,
        { description = "quit awesome", group = "awesome" }),
    awful.key({ modkey, }, "l", function() awful.tag.incmwfact(0.07) end,
        { description = "increase master width factor", group = "layout" }),
    awful.key({ modkey, }, "h", function() awful.tag.incmwfact(-0.07) end,
...
clientkeys = gears.table.join(
    awful.key({ modkey, }, "f", handle_fullscreen_of_app, { description = "toggle fullscreen", group = "client" }),
...
clientbuttons = gears.table.join(
    ...
    awful.button({ modkey }, 1, function(c)
        c:emit_signal("request::activate", "mouse_click", { raise = true })
        c.floating = true -- Set to floating
